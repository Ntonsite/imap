<?php
    ...
    $mailbox = new Mailbox(
        '{mail.accessbank.co.tz:995/pop3/ssl/novalidate-cert}', // IMAP server and mailbox folder
        'leaveapp@accessbank.co.tz', // Username for the before configured mailbox
        'ED@!maths2020', // Password for the before configured username
        __DIR__, // Directory, where attachments will be saved (optional)
        'US-ASCII' // Server encoding (optional)
    );
    try {
        $mail_ids = $mailbox->searchMailbox('SUBJECT "DONAT JOSEPH HYERA:dhyera, Annual Leave effect from 2020-05-21 to 2020-06-05"');
